...
type CreateResponse struct {
	...
	Api string `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	Id  int64  `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"` //id of created task
}
...
type ReadResponse struct {
	...
	Api  string `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	ToDo *ToDo  `protobuf:"bytes,2,opt,name=toDo,proto3" json:"toDo,omitempty"` //task entity read by id
}
...
type UpdateRequest struct {
	...
	Api  string `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	ToDo *ToDo  `protobuf:"bytes,2,opt,name=toDo,proto3" json:"toDo,omitempty"` //task entity to update
}
...
type ReadAllResponse struct {
	...
	Api   string  `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	ToDos []*ToDo `protobuf:"bytes,2,rep,name=toDos,proto3" json:"toDos,omitempty"` //list all todo tasks
}
